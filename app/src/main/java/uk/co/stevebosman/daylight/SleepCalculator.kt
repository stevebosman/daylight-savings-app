...
fun defaultWake(date: ZonedDateTime) = date.withHour(6).withMinute(30).withSecond(0)
fun defaultSleep(date: ZonedDateTime) = date.withHour(23).withMinute(0).withSecond(0)

fun wakeCalculation(yesterdaySunset: ZonedDateTime,
                    todaySunrise: ZonedDateTime, todaySunriseType: DaylightType): ZonedDateTime {
    ...
    return when (todaySunriseType) {
        ...
        DaylightType.POLAR_NIGHT -> defaultWake
            ...
            if (yesterdaySunset.plusMinutes(30).isAfter(todaySunrise.minusMinutes(idealSleepMinutes))) {
...
fun sleepCalculation(todaySunset: ZonedDateTime, todaySunsetType: DaylightType,
    ...
    return when (todaySunsetType) {
        ...
        DaylightType.POLAR_NIGHT -> default
            ...
            if (todaySunset.plusMinutes(30).isAfter(tomorrowSunrise.minusMinutes(idealSleepMinutes))) {
