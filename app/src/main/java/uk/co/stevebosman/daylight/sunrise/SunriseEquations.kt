package uk.co.stevebosman.daylight.sunrise

import uk.co.stevebosman.daylight.angles.Angle
import uk.co.stevebosman.daylight.angles.acos
import uk.co.stevebosman.daylight.angles.asin
import uk.co.stevebosman.daylight.angles.cos
import uk.co.stevebosman.daylight.angles.sin
...
fun calculateHourAngleSunrise(latitude: Angle, solarDeclination: Angle): Angle {
    try {
        val hourAngleArg =
            (cos(SolarZenithAtSunRiseSunSet) / (cos(latitude) * cos(solarDeclination)) - tan(
                latitude
            ) * tan(
                solarDeclination
            ))
